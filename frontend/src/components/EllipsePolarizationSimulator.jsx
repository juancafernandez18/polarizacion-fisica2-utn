...
// Simulador de polarización por superposición de componentes ortogonales Ex/Ey/δ,
// usado por el Problema 1 (los tres casos a/b/c de la guía). Encapsula su propio
// estado para que otros problemas puedan usar simuladores completamente distintos
// sin interferir entre sí.
function EllipsePolarizationSimulator({ problem }) {
  ...
  const analysis = useMemo(
    () => buildProblema1Analysis({ amplitudeX, amplitudeY, phaseDelta, phaseRad, isLinear, isCircular }),
    [amplitudeX, amplitudeY, phaseDelta, phaseRad, isLinear, isCircular]
  );
  ...
  return (
    <>
      ...
      <section className="section">
        <h2>6. Interpretación del resultado</h2>
        <p>
...
export default EllipsePolarizationSimulator;
